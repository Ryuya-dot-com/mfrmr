...
and review the terminal-gradient guidance when severity is `"review"` or
`"fail"`. For new analysis scripts, prefer `fit_mfrm(method = "MML")`
...
After a FACETS-oriented package-native fit is in hand, the canonical mfrmr reporting
