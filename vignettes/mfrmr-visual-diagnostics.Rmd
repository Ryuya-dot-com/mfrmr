...
In the FACETS-style view, the `*` key converts person frequencies to ruler
symbols, facet levels share the same vertical logit ruler, and each step is a
short horizontal crossing labelled with its observed-score transition. This
is visual compatibility, not a claim of numerical equality with FACETS. An
external FACETS golden output and aligned estimator/identification settings
are still required for a numerical equivalence statement.
