...
```{r wright, fig.alt = "Wright map of person abilities, facet levels and category steps on the fitted logit scale, with requested uncertainty intervals. Higher facet locations indicate stricter scoring or greater difficulty."}
...
```{r fit-pathway, fig.alt = "Infit mean squares against fitted locations for persons and facet levels, with requested location intervals. Mean-square bands are descriptive review thresholds, not automatic decisions."}
plot(
  fit,
  type = "fit_pathway",
  diagnostics = diag,
...
```{r linking, fig.alt = "Observed connections across rating-design subsets. Separate blocks identify a need to examine linking before comparing locations across subsets."}
