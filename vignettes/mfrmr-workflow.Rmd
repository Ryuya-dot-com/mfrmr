...
does not add a new acceptance test. It translates the stored readiness record.
When `FormalInference` is `"No"`, diagnostic work may continue to investigate
the stated reason, but estimates and plots remain review-only and must not be
reported as formal results.
