...
under `GPCM`. `fair_average_table(fit_gpcm)`, `build_visual_summaries()`,
and `run_qc_pipeline()` also run and return explicit caveats. Trying
`build_apa_outputs(fit_gpcm)` raises a message pointing back at
