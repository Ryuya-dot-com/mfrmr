...
Read `summary(fit)$readiness` as separate criteria. `InferenceReady` and the
Numerical row describe numerical optimization, not the design, stability,
diagnostic, or reporting decision. A small gradient cannot repair a
