...
* HTML manual validation was skipped because the local `tidy` installation does
  not look recent enough. This is classified as a local environment review item,
  not as an examples, tests, or vignette failure.
