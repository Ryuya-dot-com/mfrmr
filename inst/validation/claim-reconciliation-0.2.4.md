...
| **C10 Bias/DFF/DIF/interactions:** is this a screen or a calibrated decision? | [22 execution cases and interval/DRF repairs](interval-drf-preflight-record-0.2.4.md), including weak linking and five-anchor conditional refits. | Align generator constraints and group means before a null/alternative study. Current screens omit baseline-anchor estimation uncertainty and do not establish false-positive rates or power. |
...
| **C15 Simulation/design/resampling:** does the validation experiment answer its stated question? | Recent Person studies record independent calibration counts, reused data, paired/clustered Monte Carlo precision and failures; prior recovery/design machinery is separately scoped. | Verify truth/identification, attempted versus eligible replicates, resampling unit and Monte Carlo error for each future study. Reused transport pairs are not fresh fits or independent cell successes. DRF truth alignment remains open. |
