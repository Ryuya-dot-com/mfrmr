...
`mfrmr-readiness-0.2.3-v2` in
`readiness-contract-0.2.3.md`, its repository-only schema validator, and the
33-row adversarial fixture registry. `InferenceReady` is `TRUE` only for fit
