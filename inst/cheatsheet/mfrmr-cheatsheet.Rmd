...
# Fit follow-up (x = Infit, y = measure), including persons:
...
| `plot_wright_unified(fit, renderer="facets")` | FACETS-style `*` ruler; visual compatibility |
| `plot(fit, type="fit_pathway", diagnostics=diag, include_person=TRUE)` | Infit-vs-measure pathway |
...
*mfrmr 0.2.2 cheatsheet*. Distributed under MIT License.
