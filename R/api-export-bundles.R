...
build_conquest_overlap_command_template <- function(data_file,
  ...
  c(
    ...
    "The command requests machine-readable parameter, regression, covariance, case-EAP, and estimation-history CSV outputs.",
    "Pass the parameter, regression, covariance, and case-EAP CSV exports to mfrmr::normalize_conquest_overlap_exports().",
    "Retain the matrixout history CSV for a separate objective and free-dimension verification.",
