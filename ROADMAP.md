...
The next fixed snapshot is `v0.2.4-rc.4`. Publication checks still need
to confirm its main-branch integration, downloadable archive and
matching website. Earlier candidates remain available as unchanged
