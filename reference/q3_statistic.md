...
Large absolute values identify pairs whose residuals show stronger
positive co-movement or negative counter-movement than the main-effects
model expects. This is not the raw-residual Yen (1984) Q3 statistic.
...
- yen_threshold:
  ...
  Legacy-named argument retained for compatibility. It applies the
  strict absolute heuristic `|Q3-style| > threshold` (default `0.20`).
  Yen (1984) did not propose this as a general cutoff, and it is not
...
- `thresholds`:
  ...
  The thresholds used, for reproducibility. The `yen` name is retained
  for compatibility.
...
[`diagnose_mfrm()`](https://ryuya-dot-com.github.io/mfrmr/reference/diagnose_mfrm.md)
stores. Because model-based residual scale factors can vary across
observations, the resulting pair correlations and their null
...
aggregation. Aggregation changes the analysis unit to persons. Each
correlation is based on persons observed at both levels, so its
magnitude and null distribution are not directly comparable with raw-row
Q3.
...
- Nason, K., & DeMars, C. (2025). Another look at Yen's Q3: Is .2 an
  ...
  345-359. [doi:10.1111/jedm.12432](https://doi.org/10.1111/jedm.12432)
...
#> 3    R01    R04 -0.46313671 48 0.46313671    TRUE       TRUE        FALSE
#> 2    R01    R03 -0.43828943 48 0.43828943    TRUE       TRUE        FALSE
#> 5    R02    R04 -0.42439987 48 0.42439987    TRUE       TRUE        FALSE
#> 4    R02    R03 -0.36331502 48 0.36331502    TRUE       TRUE        FALSE
#> 6    R03    R04 -0.26385969 48 0.26385969    TRUE      FALSE        FALSE
#> 1    R01    R02 -0.01330509 48 0.01330509   FALSE      FALSE         TRUE
#>                            Interpretation
