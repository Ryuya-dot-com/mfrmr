test_that("NAMESPACE roxygen contract keeps expected exports and methods", {
  ...
  expected_exports <- c(
    ...
    # Hierarchical-audit exports added in 0.1.6.
  ...
  expected_s3 <- c(
    ...
    "S3method(print,mfrm_facet_sample_audit)",
    "S3method(summary,mfrm_facet_sample_audit)",
    ...
    # 0.1.6: sample-audit bar and nesting heatmap plots.
    "S3method(plot,mfrm_facet_sample_audit)",
