...
test_that("build_mfrm_sim_spec returns reusable simulation metadata", {
  ...
  expect_false(any(grepl("future.branch|schema.only|pilot|scaffold", printed, ignore.case = TRUE)))
...
test_that("evaluate_mfrm_design returns usable summary and plot data", {
  ...
  expect_s3_class(s$structural_design_review, "summary.mfrm_future_branch_active_branch")
...
test_that("evaluate_mfrm_signal_detection returns usable detection summaries", {
  ...
  expect_s3_class(s_sig$structural_design_review, "summary.mfrm_future_branch_active_branch")
...
test_that("predict_mfrm_population returns scenario-level forecast from sim_spec", {
  ...
  expect_s3_class(s_pred$structural_design_review, "summary.mfrm_future_branch_active_branch")
